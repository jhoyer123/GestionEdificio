...
export default function FormEditarReserva({
  ...
  // Si recibimos una reserva para editar, inicializamos el formulario con sus valores
  useEffect(() => {
    ...
    try {
      ...
      if (reservaParaEditar.horaInicio && reservaParaEditar.horaFin) {
        setModalidad("horas");
        setHoraInicio(reservaParaEditar.horaInicio);
        setHoraFin(reservaParaEditar.horaFin);
      } else if (ff) {
        setModalidad("dias");
      }
